...
class Classification():
    ...
    def GetMark(imgPath):
        ...
        return {
            ...
            'fabric-elasticity': Classification.fabricElasticityModel.names[
                fabricE.probs.top1] if fabricE != None else 'Not Found',
            'fit': Classification.fitClasses.names[fit.probs.top1] if fit != None else 'Not Found',
            'hemline': Classification.HemlineModel.names[hemline.probs.top1] if hemline != None else 'Not Found',
            ...
            'style': Classification.StyleModel.names[style.probs.top1] if style != None else 'Not Found',
            'type': Classification.typeModel.names[typet.probs.top1] if typet != None else 'Not Found',
